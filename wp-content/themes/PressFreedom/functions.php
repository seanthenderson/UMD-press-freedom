<?php 
	...
	function pressfreedom_scripts() {
		...
		//wp_register_script('googlemaps', 'https://maps.googleapis.com/maps/api/js?key= AIzaSyBeriIOCFGsrFGFa8hzfm6S9GSBTiah4lY',null,null,true);  
	...
	function my_acf_google_map_api( $api ){
    		$api['key'] = 'AIzaSyBeriIOCFGsrFGFa8hzfm6S9GSBTiah4lY';
    		return $api;
	}
